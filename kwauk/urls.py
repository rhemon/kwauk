...
urlpatterns = [
    ...
    path('member/projects/distribution/<pid>', admin.project_distributors),
    ...
    path('member/projects/<pid>/distributor/<did>', admin.distributor_form),
    ...
    path('member/projects', admin.project_list),
